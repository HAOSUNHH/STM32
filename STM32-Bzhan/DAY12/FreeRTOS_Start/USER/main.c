...
static const task_t task_tbl[] = {
	{app_task_1, 		"app_task_1", 		1024, NULL, 3, &app_task_1_handle},
	{app_task_2, 		"app_task_2", 		512, NULL, 4, &app_task_2_handle},
...
static void app_task_1(void *pvParameters)
{
	...
	for(;;){
		...
		cnt++;
		printf("app_task_1 started = %d!\r\n",cnt);
		delay(10000);
		printf("app_task_1 finished = %d!\r\n",cnt);
