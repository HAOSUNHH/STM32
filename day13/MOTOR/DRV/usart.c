...
void parse_cmd(void)
{
	...
	while(1){
		...
		if(usart1_flag){
			...
			//控制小车行走命令
			if(strstr((char *)usart1_buf,"move")){
				if(strstr((char *)usart1_buf,"front")){
					IN1 = 1;
					IN2 = 0;
					IN3 = 1;
					IN4 = 0;
				}
				else if(strstr((char *)usart1_buf,"back")){
					IN1 = 0;
					IN2 = 1;
					IN3 = 0;
					IN4 = 1;
				}
				else if(strstr((char *)usart1_buf,"stop")){
					IN1 = 0;
					IN2 = 0;
					IN3 = 0;
					IN4 = 0;
				}
				else if(strstr((char *)usart1_buf,"left")){
					IN1 = 1;
					IN2 = 0;
					IN3 = 0;
					IN4 = 0;
				}
				else if(strstr((char *)usart1_buf,"right")){
					IN1 = 0;
					IN2 = 0;
					IN3 = 1;
					IN4 = 0;
